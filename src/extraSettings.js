...
const minRandomFruitNum = reverseLevelUp ? 6 : 6; // 生成随机水果最小值（0-10）0 为葡萄，9 为半个西瓜
const maxRandomFruitNum = reverseLevelUp ? 11 : 9; // 生成随机水果最大值（1-11）0 为葡萄，9 为半个西瓜
...
let setFruits = {
  ...
  startFruits: reverseLevelUp ? [10, 10, 9, 8, 8, 7] : [8, 7, 6, 8, 7, 6],
...
let adLink = 'https://os.shining3d.cn/uploads/20210204/Fu9WXfzAplIDM2vMQd5Dr7omYWpX.png';

// 修改网页标题：将 "合成大西瓜" 进行替换
document.getElementsByTagName("title")[0].innerText = '先临-合成大红包';
